...
So, our heteroskedastic model performs better! But only just. And, it even performs just a shade worse when we look at the sum of _absolute_ rather than squared errors.
